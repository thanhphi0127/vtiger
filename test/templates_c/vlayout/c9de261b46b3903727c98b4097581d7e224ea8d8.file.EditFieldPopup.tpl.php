<?php /* Smarty version Smarty-3.1.7, created on 2016-01-01 05:36:47
         compiled from "/var/www/html/vtiger/includes/runtime/../../layouts/vlayout/modules/Settings/ModuleDesigner/EditFieldPopup.tpl" */ ?>
<?php /*%%SmartyHeaderCode:16326127165686106fbca555-61069781%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c9de261b46b3903727c98b4097581d7e224ea8d8' => 
    array (
      0 => '/var/www/html/vtiger/includes/runtime/../../layouts/vlayout/modules/Settings/ModuleDesigner/EditFieldPopup.tpl',
      1 => 1451575104,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '16326127165686106fbca555-61069781',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5686106fe9fe5',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5686106fe9fe5')) {function content_5686106fe9fe5($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
...
" onkeyup=" md_setFieldName(this, 'entity_identifier_fieldname'); md_setLabel(this, 'label', 'LBL_')"/></td>
</tr>
<tr>
...
';
	o_data.UITypeDBType					= o_data.UITypeNum == 7 && $("input[name='numeric_type']:checked").val() != 'I' ? 'DECIMAL(25,3)' : '<?php echo addslashes($_smarty_tpl->tpl_vars['a_field']->value['UITypeDBType']);?>
';
...
';
	...
	o_data.tableName					= '<?php if (!empty($_smarty_tpl->tpl_vars['a_field']->value['tableName'])){?><?php echo strtolower($_smarty_tpl->tpl_vars['a_field']->value['tableName']);?>
<?php }else{ ?>vtiger_<?php echo strtolower($_smarty_tpl->tpl_vars['moduleName']->value);?>
<?php }?>'; //TODO: Possibility to chose table name
