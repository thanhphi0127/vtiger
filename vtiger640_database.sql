...
--
-- Host: localhost
-- Generation Time: Jan 03, 2016 at 12:22 AM
...
(25, 'Note', 'Every time the record is saved', '[{"fieldname":"cf_757","operation":"is","value":"","valuetype":"","joincondition":"and","groupjoin":"and","groupid":"0"},{"fieldname":"cf_759","operation":"is","value":"","valuetype":"","joincondition":"","groupjoin":"and","groupid":"0"}]', 3, NULL, 'basic', 6, NULL, NULL, NULL, NULL, NULL, NULL);
...
(6, '12x9', 0, '{"fromEmail":"thanhphi0127@gmail.com","fromName":"admin","toEmail":"thanhphi0127@gmail.com","ccEmail":"","bccEmail":"","subject":"Regarding Contact Assignment","content":"An Contact has been assigned to you on vtigerCRM<br>Details of Contact are :<br><br>Contact Id:<b>CON1<\\/b><br>LastName:<b>PackTrict<\\/b><br>FirstName:<b>Grace<\\/b><br>Lead Source:<b><\\/b><br>Department:<b><\\/b><br>Description:<b><\\/b><br><br><br>And <b>CustomerPortal Login Details<\\/b> is sent to the EmailID :-<br><br>Thank You<br>Admin"}'),
(5, '13x10', 0, '{"fromEmail":"thanhphi0127@gmail.com","fromName":"admin","toEmail":"thanhphi0127@gmail.com","ccEmail":"","bccEmail":"","subject":"Regarding Potential Assignment","content":"An Potential has been assigned to you on vtigerCRM<br>Details of Potential are :<br><br>Potential No:<b>POT1<\\/b><br>Potential Name:<b>C\\u01a1 h\\u1ed9i b\\u00e1n h\\u00e0ng<\\/b><br>Amount:<b>0<\\/b><br>Expected Close Date:<b>02-01-2017 (dd-mm-yyyy)<\\/b><br>Type:<b><\\/b><br><br><br>Description :<br><br>Thank You<br>Admin"}');
...
(2, 'ACC1', 'Nguyễn Hoài Nam', 0, '', '', 150000000.00000000, '', '', '', '', '01662315624', '', '', '', 'www.namnguyen.com', '', 0, '0', '0', '0'),
(3, 'ACC2', 'Trần Trọng Nghĩa', 0, '', '', 0.00000000, '', '', '', '', '', '', '', '', '', '', 0, '0', '0', '0'),
(6, 'ACC3', 'Nguyễn Vương Thành Tâm', 0, '', '', 0.00000000, '', '', '', '', '', '', '', '', '', '', 0, '0', '0', '0');
...
(88, 35, 'LBL_PBXMANAGER_INFORMATION', 1, 0, 0, 0, 0, 0, 1, 0),
(89, 36, 'LBL_SERVICE_CONTRACT_INFORMATION', 1, 0, 0, 0, 0, 0, 1, 0),
(90, 36, 'LBL_CUSTOM_INFORMATION', 2, 0, 0, 0, 0, 0, 1, 0),
...
(95, 38, 'LBL_PROJECT_MILESTONE_INFORMATION', 1, 0, 0, 0, 0, 0, 1, 0),
(96, 38, 'LBL_CUSTOM_INFORMATION', 2, 0, 0, 0, 0, 0, 1, 0),
(97, 38, 'LBL_DESCRIPTION_INFORMATION', 3, 0, 0, 0, 0, 0, 1, 0),
(98, 39, 'LBL_PROJECT_TASK_INFORMATION', 1, 0, 0, 0, 0, 0, 1, 0),
(99, 39, 'LBL_CUSTOM_INFORMATION', 2, 0, 0, 0, 0, 0, 1, 0),
(100, 39, 'LBL_DESCRIPTION_INFORMATION', 3, 0, 0, 0, 0, 0, 1, 0),
(101, 40, 'LBL_PROJECT_INFORMATION', 1, 0, 0, 0, 0, 0, 1, 0),
(102, 40, 'LBL_CUSTOM_INFORMATION', 2, 0, 0, 0, 0, 0, 1, 0),
(103, 40, 'LBL_DESCRIPTION_INFORMATION', 3, 0, 0, 0, 0, 0, 1, 0),
(104, 41, 'LBL_SMSNOTIFIER_INFORMATION', 1, 0, 0, 0, 0, 0, 1, 0),
(105, 41, 'LBL_CUSTOM_INFORMATION', 2, 0, 0, 0, 0, 0, 1, 0),
(106, 41, 'StatusInformation', 3, 0, 0, 0, 0, 0, 1, 0),
(107, 42, 'LBL_MODCOMMENTS_INFORMATION', 1, 0, 0, 0, 0, 0, 1, 0),
(108, 42, 'LBL_OTHER_INFORMATION', 2, 0, 0, 0, 0, 0, 1, 0),
(109, 42, 'LBL_CUSTOM_INFORMATION', 3, 0, 0, 0, 0, 0, 1, 0),
...
(129, 55, 'LBL_PERSONNOTE_INFORMATION', 1, 0, 0, 0, 0, 0, 1, 0),
(130, 55, 'LBL_CUSTOM_INFORMATION', 2, 0, 0, 0, 0, 0, 1, 0);
...
--
-- Table structure for table `vtiger_cf_785`
--

CREATE TABLE IF NOT EXISTS `vtiger_cf_785` (
  `cf_785id` int(11) NOT NULL,
  `cf_785` varchar(200) NOT NULL,
  `presence` int(1) NOT NULL DEFAULT '1',
  `picklist_valueid` int(11) NOT NULL DEFAULT '0',
  `sortorderid` int(11) DEFAULT '0'
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `vtiger_cf_785`
--

INSERT INTO `vtiger_cf_785` (`cf_785id`, `cf_785`, `presence`, `picklist_valueid`, `sortorderid`) VALUES
(1, 'High', 1, 307, 1),
(2, 'Medium', 1, 308, 2),
(3, 'Low', 1, 309, 3),
(4, 'None', 1, 310, 4);
...
--
-- Table structure for table `vtiger_cf_785_seq`
--

CREATE TABLE IF NOT EXISTS `vtiger_cf_785_seq` (
  `id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `vtiger_cf_785_seq`
--

INSERT INTO `vtiger_cf_785_seq` (`id`) VALUES
(4);
...
(9, 'CON1', 0, 'Mr.', 'Grace', 'PackTrict', '', '', '0986233166', '', '', '', '0', NULL, NULL, NULL, NULL, '', '0', '0', '', '0', '0', '0');
...
(2, 1, 1, 1, 'Accounts', '', '2015-12-31 15:58:43', '2015-12-31 15:58:43', NULL, NULL, 0, 1, 0, 'Nguyễn Hoài Nam'),
(3, 1, 1, 1, 'Accounts', '', '2015-12-31 15:59:39', '2015-12-31 15:59:39', NULL, NULL, 0, 1, 0, 'Trần Trọng Nghĩa'),
(4, 1, 1, 1, 'Products', '', '2015-12-31 16:00:36', '2015-12-31 16:01:41', NULL, NULL, 0, 1, 0, 'Xe honda'),
(5, 1, 1, 1, 'Quotes', '', '2015-12-31 16:01:53', '2015-12-31 16:01:53', NULL, NULL, 0, 1, 0, 'Báo gía 1'),
(6, 1, 1, 1, 'Accounts', '', '2015-12-31 16:02:20', '2015-12-31 16:02:20', NULL, NULL, 0, 1, 0, 'Nguyễn Vương Thành Tâm'),
(7, 1, 1, 1, 'Quotes', '', '2015-12-31 16:03:11', '2015-12-31 16:03:11', NULL, NULL, 0, 1, 0, 'Báo gía 2'),
(8, 1, 1, 1, 'Products', '', '2015-12-31 16:03:48', '2015-12-31 16:04:12', NULL, NULL, 0, 1, 0, 'Rượu Nga'),
(9, 1, 1, 1, 'Contacts', '', '2016-01-01 02:51:20', '2016-01-01 02:51:20', NULL, NULL, 0, 1, 0, 'Grace PackTrict'),
(10, 1, 1, 1, 'Potentials', '', '2016-01-01 02:52:25', '2016-01-01 02:52:25', NULL, NULL, 0, 1, 0, 'Cơ hội bán hàng'),
(11, 1, 1, 1, 'Note', NULL, '2016-01-01 06:05:01', '2016-01-01 06:20:36', NULL, NULL, 0, 1, 0, NULL),
(12, 1, 1, 1, 'Faq', NULL, '2016-01-01 06:25:15', '2016-01-01 06:25:15', NULL, NULL, 0, 1, 0, 'a'),
(13, 1, 1, 1, 'Faq', NULL, '2016-01-01 06:26:16', '2016-01-01 06:26:16', NULL, NULL, 0, 1, 0, 'b'),
(14, 1, 1, 1, 'Note', NULL, '2016-01-01 06:34:28', '2016-01-01 06:34:28', NULL, NULL, 0, 1, 0, NULL),
(15, 1, 1, 1, 'TestModule', NULL, '2016-01-02 16:24:22', '2016-01-02 16:24:22', NULL, NULL, 0, 1, 0, 'a'),
(16, 1, 1, 1, 'PersonNote', NULL, '2016-01-02 16:29:30', '2016-01-02 17:12:57', NULL, NULL, 0, 1, 0, 'Gặp mặt xếp');
...
(44, 3, 'vtiger_crmentity:createdtime:createdtime:SMSNotifier_Created_Time:DT'),
(44, 4, 'vtiger_crmentity:modifiedtime:modifiedtime:SMSNotifier_Modified_Time:DT'),
...
(45, 2, 'vtiger_crmentity:modifiedtime:modifiedtime:ModComments_Modified_Time:DT'),
...
(55, 0, 'vtiger_personnote:title:title:PersonNote_Title:V'),
(55, 1, 'vtiger_crmentity:smownerid:assigned_user_id:PersonNote_Assigned_To:V'),
(55, 2, 'vtiger_crmentity:createdtime:createdtime:PersonNote_Created_Time:T');
...
(36, 'ServiceContracts', 'vtiger_servicecontracts', 'subject', 'servicecontractsid', 'servicecontractsid'),
(37, 'Services', 'vtiger_service', 'servicename', 'serviceid', 'serviceid'),
(38, 'ProjectMilestone', 'vtiger_projectmilestone', 'projectmilestonename', 'projectmilestoneid', 'projectmilestoneid'),
(39, 'ProjectTask', 'vtiger_projecttask', 'projecttaskname', 'projecttaskid', 'projecttaskid'),
(40, 'Project', 'vtiger_project', 'projectname', 'projectid', 'projectid'),
...
(55, 'PersonNote', 'vtiger_personnote', 'title', 'personnoteid', 'personnoteid');
...
(12, 'FAQ1', '0', 'a', 'aa', 'General', 'Draft'),
(13, 'FAQ2', '0', 'b', 'b', 'General', 'Published');
...
(35, 524, 'direction', 'vtiger_pbxmanager', 1, '1', 'direction', 'Direction', 1, 2, '', 100, 1, 88, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(35, 525, 'callstatus', 'vtiger_pbxmanager', 1, '1', 'callstatus', 'Call Status', 1, 2, '', 100, 2, 88, 1, 'V~O', 1, NULL, 'BAS', 1, '', 1),
(35, 526, 'starttime', 'vtiger_pbxmanager', 1, '70', 'starttime', 'Start Time', 1, 2, '', 100, 7, 88, 1, 'DT~O', 1, NULL, 'BAS', 1, '', 1),
(35, 527, 'endtime', 'vtiger_pbxmanager', 1, '70', 'endtime', 'End Time', 1, 2, '', 100, 8, 88, 1, 'DT~O', 1, NULL, 'BAS', 1, '', 0),
(35, 528, 'totalduration', 'vtiger_pbxmanager', 1, '7', 'totalduration', 'Total Duration', 1, 2, '', 100, 10, 88, 1, 'I~O', 1, NULL, 'BAS', 1, '', 0),
(35, 529, 'billduration', 'vtiger_pbxmanager', 1, '7', 'billduration', 'Bill Duration', 1, 2, '', 100, 11, 88, 1, 'I~O', 1, NULL, 'BAS', 1, '', 0),
(35, 530, 'recordingurl', 'vtiger_pbxmanager', 1, '17', 'recordingurl', 'Recording URL', 1, 2, '', 100, 9, 88, 1, 'V~O', 1, NULL, 'BAS', 1, '', 1),
(35, 531, 'sourceuuid', 'vtiger_pbxmanager', 1, '1', 'sourceuuid', 'Source UUID', 1, 2, '', 100, 12, 88, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(35, 532, 'gateway', 'vtiger_pbxmanager', 1, '1', 'gateway', 'Gateway', 1, 2, '', 100, 13, 88, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(35, 533, 'customer', 'vtiger_pbxmanager', 1, '10', 'customer', 'Customer', 1, 2, '', 100, 3, 88, 1, 'V~O', 1, NULL, 'BAS', 1, '', 1),
(35, 534, 'user', 'vtiger_pbxmanager', 1, '52', 'user', 'User', 1, 2, '', 100, 4, 88, 1, 'V~O', 1, NULL, 'BAS', 1, '', 1),
(35, 535, 'customernumber', 'vtiger_pbxmanager', 1, '11', 'customernumber', 'Customer Number', 1, 2, '', 100, 5, 88, 1, 'V~M', 1, NULL, 'BAS', 1, '', 0),
(35, 536, 'customertype', 'vtiger_pbxmanager', 1, '1', 'customertype', 'Customer Type', 1, 2, '', 100, 6, 88, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(35, 537, 'smownerid', 'vtiger_crmentity', 1, '53', 'assigned_user_id', 'Assigned To', 1, 2, '', 100, 14, 88, 1, 'V~M', 1, NULL, 'BAS', 1, '', 0),
(35, 538, 'createdtime', 'vtiger_crmentity', 1, '70', 'CreatedTime', 'Created Time', 1, 2, '', 100, 15, 88, 2, 'DT~O', 1, NULL, 'BAS', 1, '', 0),
(35, 539, 'modifiedtime', 'vtiger_crmentity', 1, '70', 'ModifiedTime', 'Modified Time', 1, 2, '', 100, 16, 88, 2, 'DT~O', 1, NULL, 'BAS', 1, '', 0),
(29, 540, 'phone_crm_extension', 'vtiger_users', 1, '11', 'phone_crm_extension', 'CRM Phone Extension', 1, 2, '', 100, 18, 79, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(36, 541, 'smownerid', 'vtiger_crmentity', 1, '53', 'assigned_user_id', 'Assigned To', 1, 2, '', 100, 4, 89, 1, 'V~M', 2, 2, 'BAS', 1, '', 1),
(36, 542, 'createdtime', 'vtiger_crmentity', 1, '70', 'createdtime', 'Created Time', 1, 0, '', 100, 17, 89, 2, 'DT~O', 3, 0, 'BAS', 0, '', 0),
(36, 543, 'modifiedtime', 'vtiger_crmentity', 1, '70', 'modifiedtime', 'Modified Time', 1, 0, '', 100, 18, 89, 2, 'DT~O', 3, 0, 'BAS', 0, '', 0),
(36, 544, 'start_date', 'vtiger_servicecontracts', 1, '5', 'start_date', 'Start Date', 1, 2, '', 100, 7, 89, 1, 'D~O', 2, 4, 'BAS', 1, '', 0),
(36, 545, 'end_date', 'vtiger_servicecontracts', 1, '5', 'end_date', 'End Date', 1, 2, '', 100, 11, 89, 2, 'D~O', 3, 0, 'BAS', 0, '', 0),
(36, 546, 'sc_related_to', 'vtiger_servicecontracts', 1, '10', 'sc_related_to', 'Related to', 1, 2, '', 100, 3, 89, 1, 'V~O', 2, 6, 'BAS', 1, '', 0),
(36, 547, 'tracking_unit', 'vtiger_servicecontracts', 1, '15', 'tracking_unit', 'Tracking Unit', 1, 2, '', 100, 6, 89, 1, 'V~O', 2, 7, 'BAS', 1, '', 0),
(36, 548, 'total_units', 'vtiger_servicecontracts', 1, '7', 'total_units', 'Total Units', 1, 2, '', 100, 8, 89, 1, 'V~O', 2, 8, 'BAS', 1, '', 1),
(36, 549, 'used_units', 'vtiger_servicecontracts', 1, '7', 'used_units', 'Used Units', 1, 2, '', 100, 10, 89, 1, 'V~O', 2, 9, 'BAS', 1, '', 1),
(36, 550, 'subject', 'vtiger_servicecontracts', 1, '1', 'subject', 'Subject', 1, 0, '', 100, 1, 89, 1, 'V~M', 0, 1, 'BAS', 1, '', 1),
(36, 551, 'due_date', 'vtiger_servicecontracts', 1, '23', 'due_date', 'Due date', 1, 2, '', 100, 9, 89, 1, 'D~O', 2, 5, 'BAS', 1, '', 0),
(36, 552, 'planned_duration', 'vtiger_servicecontracts', 1, '1', 'planned_duration', 'Planned Duration', 1, 2, '', 100, 13, 89, 2, 'V~O', 3, 0, 'BAS', 0, '', 0),
(36, 553, 'actual_duration', 'vtiger_servicecontracts', 1, '1', 'actual_duration', 'Actual Duration', 1, 2, '', 100, 15, 89, 2, 'V~O', 3, 0, 'BAS', 0, '', 0),
(36, 554, 'contract_status', 'vtiger_servicecontracts', 1, '15', 'contract_status', 'Status', 1, 2, '', 100, 12, 89, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(36, 555, 'priority', 'vtiger_servicecontracts', 1, '15', 'contract_priority', 'Priority', 1, 2, '', 100, 14, 89, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(36, 556, 'contract_type', 'vtiger_servicecontracts', 1, '15', 'contract_type', 'Type', 1, 2, '', 100, 5, 89, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(36, 557, 'progress', 'vtiger_servicecontracts', 1, '9', 'progress', 'Progress', 1, 2, '', 100, 16, 89, 2, 'N~O~2~2', 3, 3, 'BAS', 0, '', 0),
(36, 558, 'contract_no', 'vtiger_servicecontracts', 1, '4', 'contract_no', 'Contract No', 1, 0, '', 100, 2, 89, 1, 'V~O', 3, 0, 'BAS', 0, '', 1),
(36, 559, 'modifiedby', 'vtiger_crmentity', 1, '52', 'modifiedby', 'Last Modified By', 1, 0, '', 100, 17, 89, 3, 'V~O', 3, 0, 'BAS', 0, '', 0),
...
(37, 575, 'unit_price', 'vtiger_service', 1, '72', 'unit_price', 'Price', 1, 0, '', 100, 1, 92, 1, 'N~O', 2, 2, 'BAS', 0, '', 1),
...
(38, 579, 'projectmilestonename', 'vtiger_projectmilestone', 1, '2', 'projectmilestonename', 'Project Milestone Name', 1, 2, '', 100, 1, 95, 1, 'V~M', 0, 1, 'BAS', 1, '', 1),
(38, 580, 'projectmilestonedate', 'vtiger_projectmilestone', 1, '5', 'projectmilestonedate', 'Milestone Date', 1, 2, '', 100, 5, 95, 1, 'D~O', 0, 3, 'BAS', 1, '', 1),
(38, 581, 'projectid', 'vtiger_projectmilestone', 1, '10', 'projectid', 'Related to', 1, 0, '', 100, 4, 95, 1, 'V~M', 0, 4, 'BAS', 1, '', 0),
(38, 582, 'projectmilestonetype', 'vtiger_projectmilestone', 1, '15', 'projectmilestonetype', 'Type', 1, 2, '', 100, 7, 95, 1, 'V~O', 1, NULL, 'BAS', 1, '', 1),
(38, 583, 'smownerid', 'vtiger_crmentity', 1, '53', 'assigned_user_id', 'Assigned To', 1, 2, '', 100, 6, 95, 1, 'V~M', 0, 2, 'BAS', 1, '', 0),
(38, 584, 'projectmilestone_no', 'vtiger_projectmilestone', 2, '4', 'projectmilestone_no', 'Project Milestone No', 1, 0, '', 100, 2, 95, 1, 'V~O', 3, 4, 'BAS', 0, '', 0),
(38, 585, 'createdtime', 'vtiger_crmentity', 1, '70', 'createdtime', 'Created Time', 1, 2, '', 100, 1, 96, 2, 'T~O', 1, NULL, 'BAS', 1, '', 0),
(38, 586, 'modifiedtime', 'vtiger_crmentity', 1, '70', 'modifiedtime', 'Modified Time', 1, 2, '', 100, 2, 96, 2, 'T~O', 1, NULL, 'BAS', 1, '', 0),
(38, 587, 'modifiedby', 'vtiger_crmentity', 1, '52', 'modifiedby', 'Last Modified By', 1, 0, '', 100, 3, 96, 3, 'V~O', 3, 0, 'BAS', 0, '', 0),
(38, 588, 'description', 'vtiger_crmentity', 1, '19', 'description', 'description', 1, 2, '', 100, 1, 97, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(39, 589, 'projecttaskname', 'vtiger_projecttask', 1, '2', 'projecttaskname', 'Project Task Name', 1, 2, '', 100, 1, 98, 1, 'V~M', 0, 1, 'BAS', 1, '', 1),
(39, 590, 'projecttasktype', 'vtiger_projecttask', 1, '15', 'projecttasktype', 'Type', 1, 2, '', 100, 4, 98, 1, 'V~O', 1, NULL, 'BAS', 1, '', 1),
(39, 591, 'projecttaskpriority', 'vtiger_projecttask', 1, '15', 'projecttaskpriority', 'Priority', 1, 2, '', 100, 3, 98, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(39, 592, 'projectid', 'vtiger_projecttask', 1, '10', 'projectid', 'Related to', 1, 0, '', 100, 6, 98, 1, 'V~M', 0, 5, 'BAS', 1, '', 0),
(39, 593, 'smownerid', 'vtiger_crmentity', 1, '53', 'assigned_user_id', 'Assigned To', 1, 2, '', 100, 7, 98, 1, 'V~M', 0, 2, 'BAS', 1, '', 1),
(39, 594, 'projecttasknumber', 'vtiger_projecttask', 1, '7', 'projecttasknumber', 'Project Task Number', 1, 2, '', 100, 5, 98, 1, 'I~O', 1, NULL, 'BAS', 1, '', 0),
(39, 595, 'projecttask_no', 'vtiger_projecttask', 2, '4', 'projecttask_no', 'Project Task No', 1, 0, '', 100, 2, 98, 1, 'V~O', 3, 4, 'BAS', 0, '', 0),
(39, 596, 'projecttaskprogress', 'vtiger_projecttask', 1, '15', 'projecttaskprogress', 'Progress', 1, 2, '', 100, 1, 99, 1, 'V~O', 1, NULL, 'BAS', 1, '', 1),
(39, 597, 'projecttaskhours', 'vtiger_projecttask', 1, '7', 'projecttaskhours', 'Worked Hours', 1, 2, '', 100, 2, 99, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(39, 598, 'startdate', 'vtiger_projecttask', 1, '5', 'startdate', 'Start Date', 1, 2, '', 100, 3, 99, 1, 'D~O', 0, 3, 'BAS', 1, '', 1),
(39, 599, 'enddate', 'vtiger_projecttask', 1, '5', 'enddate', 'End Date', 1, 2, '', 100, 4, 99, 1, 'D~O~OTH~GE~startdate~Start Date', 1, NULL, 'BAS', 1, '', 1),
(39, 600, 'createdtime', 'vtiger_crmentity', 1, '70', 'createdtime', 'Created Time', 1, 2, '', 100, 5, 99, 2, 'T~O', 1, NULL, 'BAS', 1, '', 0),
(39, 601, 'modifiedtime', 'vtiger_crmentity', 1, '70', 'modifiedtime', 'Modified Time', 1, 2, '', 100, 6, 99, 2, 'T~O', 1, NULL, 'BAS', 1, '', 0),
(39, 602, 'modifiedby', 'vtiger_crmentity', 1, '52', 'modifiedby', 'Last Modified By', 1, 0, '', 100, 7, 99, 3, 'V~O', 3, 0, 'BAS', 0, '', 0),
(39, 603, 'description', 'vtiger_crmentity', 1, '19', 'description', 'description', 1, 2, '', 100, 1, 100, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(40, 604, 'projectname', 'vtiger_project', 1, '2', 'projectname', 'Project Name', 1, 2, '', 100, 1, 101, 1, 'V~M', 0, 1, 'BAS', 1, '', 1),
(40, 605, 'startdate', 'vtiger_project', 1, '23', 'startdate', 'Start Date', 1, 2, '', 100, 3, 101, 1, 'D~O', 0, 3, 'BAS', 1, '', 1),
(40, 606, 'targetenddate', 'vtiger_project', 1, '23', 'targetenddate', 'Target End Date', 1, 2, '', 100, 5, 101, 1, 'D~O~OTH~GE~startdate~Start Date', 0, 4, 'BAS', 1, '', 1),
(40, 607, 'actualenddate', 'vtiger_project', 1, '23', 'actualenddate', 'Actual End Date', 1, 2, '', 100, 6, 101, 1, 'D~O~OTH~GE~startdate~Start Date', 1, NULL, 'BAS', 1, '', 0),
(40, 608, 'projectstatus', 'vtiger_project', 1, '15', 'projectstatus', 'Status', 1, 2, '', 100, 7, 101, 1, 'V~O', 1, NULL, 'BAS', 1, '', 1),
(40, 609, 'projecttype', 'vtiger_project', 1, '15', 'projecttype', 'Type', 1, 2, '', 100, 8, 101, 1, 'V~O', 1, NULL, 'BAS', 1, '', 1),
(40, 610, 'linktoaccountscontacts', 'vtiger_project', 1, '10', 'linktoaccountscontacts', 'Related to', 1, 2, '', 100, 9, 101, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(40, 611, 'smownerid', 'vtiger_crmentity', 1, '53', 'assigned_user_id', 'Assigned To', 1, 2, '', 100, 4, 101, 1, 'V~M', 0, 2, 'BAS', 1, '', 1),
(40, 612, 'project_no', 'vtiger_project', 2, '4', 'project_no', 'Project No', 1, 0, '', 100, 2, 101, 1, 'V~O', 3, 0, 'BAS', 0, '', 0),
(40, 613, 'targetbudget', 'vtiger_project', 1, '7', 'targetbudget', 'Target Budget', 1, 2, '', 100, 1, 102, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(40, 614, 'projecturl', 'vtiger_project', 1, '17', 'projecturl', 'Project Url', 1, 2, '', 100, 2, 102, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(40, 615, 'projectpriority', 'vtiger_project', 1, '15', 'projectpriority', 'Priority', 1, 2, '', 100, 3, 102, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(40, 616, 'progress', 'vtiger_project', 1, '15', 'progress', 'Progress', 1, 2, '', 100, 4, 102, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(40, 617, 'createdtime', 'vtiger_crmentity', 1, '70', 'createdtime', 'Created Time', 1, 2, '', 100, 5, 102, 2, 'T~O', 1, NULL, 'BAS', 1, '', 0),
(40, 618, 'modifiedtime', 'vtiger_crmentity', 1, '70', 'modifiedtime', 'Modified Time', 1, 2, '', 100, 6, 102, 2, 'T~O', 1, NULL, 'BAS', 1, '', 0),
(40, 619, 'modifiedby', 'vtiger_crmentity', 1, '52', 'modifiedby', 'Last Modified By', 1, 0, '', 100, 7, 102, 3, 'V~O', 3, 0, 'BAS', 0, '', 0),
(40, 620, 'description', 'vtiger_crmentity', 1, '19', 'description', 'description', 1, 2, '', 100, 1, 103, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(41, 621, 'smownerid', 'vtiger_crmentity', 1, '53', 'assigned_user_id', 'Assigned To', 1, 0, '', 100, 2, 104, 1, 'V~M', 1, NULL, 'BAS', 1, '', 1),
(41, 622, 'createdtime', 'vtiger_crmentity', 1, '70', 'createdtime', 'Created Time', 1, 0, '', 100, 5, 104, 2, 'DT~O', 1, NULL, 'BAS', 0, '', 0),
(41, 623, 'modifiedtime', 'vtiger_crmentity', 1, '70', 'modifiedtime', 'Modified Time', 1, 0, '', 100, 6, 104, 2, 'DT~O', 1, NULL, 'BAS', 0, '', 0),
(41, 624, 'message', 'vtiger_smsnotifier', 1, '21', 'message', 'message', 1, 0, '', 100, 1, 104, 1, 'V~M', 1, NULL, 'BAS', 1, '', 1),
(41, 625, 'modifiedby', 'vtiger_crmentity', 1, '52', 'modifiedby', 'Last Modified By', 1, 0, '', 100, 7, 104, 3, 'V~O', 1, NULL, 'BAS', 0, '', 0),
(42, 626, 'commentcontent', 'vtiger_modcomments', 1, '19', 'commentcontent', 'Comment', 1, 0, '', 100, 4, 107, 1, 'V~M', 0, 4, 'BAS', 2, '', 1),
(42, 627, 'smownerid', 'vtiger_crmentity', 1, '53', 'assigned_user_id', 'Assigned To', 1, 0, '', 100, 1, 108, 1, 'V~M', 0, 1, 'BAS', 2, '', 1),
(42, 628, 'createdtime', 'vtiger_crmentity', 1, '70', 'createdtime', 'Created Time', 1, 0, '', 100, 5, 108, 2, 'DT~O', 0, 2, 'BAS', 0, '', 0),
(42, 629, 'modifiedtime', 'vtiger_crmentity', 1, '70', 'modifiedtime', 'Modified Time', 1, 0, '', 100, 6, 108, 2, 'DT~O', 0, 3, 'BAS', 0, '', 0),
(42, 630, 'related_to', 'vtiger_modcomments', 1, '10', 'related_to', 'Related To', 1, 2, '', 100, 2, 108, 1, 'V~M', 2, 5, 'BAS', 2, '', 0),
(42, 631, 'smcreatorid', 'vtiger_crmentity', 1, '52', 'creator', 'Creator', 1, 2, '', 100, 4, 108, 2, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(42, 632, 'parent_comments', 'vtiger_modcomments', 1, '10', 'parent_comments', 'Related To Comments', 1, 2, '', 100, 7, 108, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
...
(39, 690, 'projecttaskstatus', 'vtiger_projecttask', 1, '15', 'projecttaskstatus', 'Status', 1, 2, '', 100, 8, 98, 1, 'V~O', 0, 6, 'BAS', 1, '', 0),
(42, 691, 'customer', 'vtiger_modcomments', 1, '10', 'customer', 'Customer', 1, 2, '', 100, 5, 107, 3, 'V~O', 1, NULL, 'BAS', 1, '', 0),
...
(42, 710, 'userid', 'vtiger_modcomments', 1, '10', 'userid', 'UserId', 1, 2, '', 100, 6, 107, 3, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(42, 711, 'reasontoedit', 'vtiger_modcomments', 1, '19', 'reasontoedit', 'ReasonToEdit', 1, 2, '', 100, 7, 107, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
...
(55, 773, 'title', 'vtiger_personnote', 1, '2', 'title', 'Title', 1, 2, '', 100, 1, 129, 1, 'V~M', 1, NULL, 'BAS', 1, '', 0),
(55, 774, 'smownerid', 'vtiger_crmentity', 1, '53', 'assigned_user_id', 'Assigned To', 1, 2, '', 100, 2, 129, 1, 'V~M', 2, NULL, 'BAS', 1, '', 1),
(55, 775, 'createdtime', 'vtiger_crmentity', 1, '70', 'createdtime', 'Created Time', 1, 2, '', 100, 3, 129, 2, 'T~O', 1, NULL, 'BAS', 1, '', 0),
(55, 776, 'modifiedtime', 'vtiger_crmentity', 1, '70', 'modifiedtime', 'Modified Time', 1, 2, '', 100, 4, 129, 2, 'T~O', 1, NULL, 'BAS', 1, '', 0),
(55, 782, 'cf_781', 'vtiger_personnotecf', 2, '21', 'cf_781', 'Summary', 1, 2, '', 100, 5, 129, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(55, 786, 'cf_785', 'vtiger_personnotecf', 2, '33', 'cf_785', 'Critical Levels', 1, 2, '', 100, 6, 129, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0);
...
(581, 'ProjectMilestone', 'Project', NULL, NULL),
(592, 'ProjectTask', 'Project', NULL, NULL),
(610, 'Project', 'Accounts', NULL, NULL),
(610, 'Project', 'Contacts', NULL, NULL),
(630, 'ModComments', 'Leads', NULL, NULL),
(630, 'ModComments', 'Contacts', NULL, NULL),
(630, 'ModComments', 'Accounts', NULL, NULL),
(632, 'ModComments', 'ModComments', NULL, NULL),
(630, 'ModComments', 'Potentials', NULL, NULL),
(630, 'ModComments', 'Project', NULL, NULL),
(630, 'ModComments', 'ProjectTask', NULL, NULL),
...
(630, 'ModComments', 'HelpDesk', NULL, NULL),
(630, 'ModComments', 'Faq', NULL, NULL),
...
(5, 4, 1, 1.000, 12000000.00000000, NULL, NULL, '', NULL, 0, 1, 4.500, 10.000, 12.500),
(7, 4, 1, 2.000, 12000000.00000000, NULL, NULL, '', NULL, 0, 2, 4.500, 10.000, 12.500);
...
(1, 'English', 'en_us', 'US English', '2015-12-31 14:31:49', NULL, 1, 1),
(2, 'Russian', 'ru_ru', 'Russian', '2015-12-31 14:37:10', NULL, 0, 1),
(3, 'British English', 'en_gb', 'British English', '2015-12-31 14:37:11', NULL, 0, 1),
(4, 'Mexican Spanish', 'es_mx', 'ES Mexico', '2015-12-31 14:37:11', NULL, 0, 1),
(5, 'Pack de langue français', 'fr_fr', 'Pack de langue français', '2015-12-31 14:38:27', NULL, 0, 1),
(6, 'Deutsch', 'de_de', 'DE Deutsch', '2015-12-31 14:37:50', NULL, 0, 1),
(7, 'Swedish', 'sv_se', 'Swedish', '2015-12-31 14:41:02', NULL, 0, 1),
(8, 'Arabic', 'ar_ae', 'Arabic', '2015-12-31 14:41:02', NULL, 0, 1),
(9, 'Dutch', 'nl_nl', 'NL-Dutch', '2015-12-31 14:37:58', NULL, 0, 1),
(10, 'Brazilian', 'pt_br', 'PT Brasil', '2015-12-31 14:38:27', NULL, 0, 1),
(11, 'Romana', 'ro_ro', 'Romana', '2015-12-31 14:38:27', NULL, 0, 1),
(12, 'Italian', 'it_it', 'IT Italian', '2015-12-31 14:37:58', NULL, 0, 1),
(13, 'Język Polski', 'pl_pl', 'Język Polski', '2015-12-31 14:38:27', NULL, 0, 1),
(14, 'Hungarian', 'hu_hu', 'HU Magyar', '2015-12-31 14:38:09', NULL, 0, 1),
(15, 'Spanish', 'es_es', 'ES Spanish', '2015-12-31 14:38:09', NULL, 0, 1),
(16, 'Turkce', 'tr_tr', 'Turkce Dil Paketi', '2015-12-31 14:38:09', NULL, 0, 1);
...
(9, 41, 'DETAILVIEWBASIC', 'LBL_CHECK_STATUS', 'javascript:SMSNotifier.checkstatus($RECORD$)', 'themes/images/reload.gif', 0, NULL, NULL, NULL),
(11, 41, 'HEADERSCRIPT', 'SMSNotifierCommonJS', 'modules/SMSNotifier/SMSNotifierCommon.js', '', 0, NULL, NULL, NULL),
(12, 7, 'LISTVIEWBASIC', 'Send SMS', 'SMSNotifierCommon.displaySelectWizard(this, ''$MODULE$'');', '', 0, NULL, NULL, NULL),
(13, 7, 'DETAILVIEWBASIC', 'Send SMS', 'javascript:SMSNotifierCommon.displaySelectWizard_DetailView(''$MODULE$'', ''$RECORD$'');', '', 0, NULL, NULL, NULL),
(14, 4, 'LISTVIEWBASIC', 'Send SMS', 'SMSNotifierCommon.displaySelectWizard(this, ''$MODULE$'');', '', 0, NULL, NULL, NULL),
(15, 4, 'DETAILVIEWBASIC', 'Send SMS', 'javascript:SMSNotifierCommon.displaySelectWizard_DetailView(''$MODULE$'', ''$RECORD$'');', '', 0, NULL, NULL, NULL),
(16, 6, 'LISTVIEWBASIC', 'Send SMS', 'SMSNotifierCommon.displaySelectWizard(this, ''$MODULE$'');', '', 0, NULL, NULL, NULL),
(17, 6, 'DETAILVIEWBASIC', 'Send SMS', 'javascript:SMSNotifierCommon.displaySelectWizard_DetailView(''$MODULE$'', ''$RECORD$'');', '', 0, NULL, NULL, NULL),
(18, 42, 'HEADERSCRIPT', 'ModCommentsCommonHeaderScript', 'modules/ModComments/ModCommentsCommon.js', '', 0, NULL, NULL, NULL),
(19, 7, 'DETAILVIEWWIDGET', 'DetailViewBlockCommentWidget', 'block://ModComments:modules/ModComments/ModComments.php', '', 0, NULL, NULL, NULL),
(20, 4, 'DETAILVIEWWIDGET', 'DetailViewBlockCommentWidget', 'block://ModComments:modules/ModComments/ModComments.php', '', 0, NULL, NULL, NULL),
(21, 6, 'DETAILVIEWWIDGET', 'DetailViewBlockCommentWidget', 'block://ModComments:modules/ModComments/ModComments.php', '', 0, NULL, NULL, NULL),
(22, 2, 'DETAILVIEWWIDGET', 'DetailViewBlockCommentWidget', 'block://ModComments:modules/ModComments/ModComments.php', '', 0, NULL, NULL, NULL),
...
(30, 39, 'DETAILVIEWBASIC', 'Add Note', 'index.php?module=Documents&action=EditView&return_module=ProjectTask&return_action=DetailView&return_id=$RECORD$&parent_id=$RECORD$', '', 0, 'modules/Documents/Documents.php', 'Documents', 'isLinkPermitted'),
(31, 39, 'DETAILVIEWWIDGET', 'DetailViewBlockCommentWidget', 'block://ModComments:modules/ModComments/ModComments.php', '', 0, NULL, NULL, NULL),
(32, 40, 'DETAILVIEWBASIC', 'Add Project Task', 'index.php?module=ProjectTask&action=EditView&projectid=$RECORD$&return_module=Project&return_action=DetailView&return_id=$RECORD$', '', 0, 'modules/ProjectTask/ProjectTask.php', 'ProjectTask', 'isLinkPermitted'),
(33, 40, 'DETAILVIEWBASIC', 'Add Note', 'index.php?module=Documents&action=EditView&return_module=Project&return_action=DetailView&return_id=$RECORD$&parent_id=$RECORD$', '', 1, 'modules/Documents/Documents.php', 'Documents', 'isLinkPermitted'),
(34, 40, 'DETAILVIEWWIDGET', 'DetailViewBlockCommentWidget', 'block://ModComments:modules/ModComments/ModComments.php', '', 0, NULL, NULL, NULL),
...
(1, 'admin', '127.0.0.1', '2015-12-31 08:02:54', '2015-12-31 07:41:42', 'Signed off'),
(2, 'admin', '127.0.0.1', '0000-00-00 00:00:00', '2015-12-31 08:10:21', 'Signed in'),
(3, 'admin', '127.0.0.1', '0000-00-00 00:00:00', '2015-12-31 19:18:32', 'Signed in'),
(4, 'admin', '127.0.0.1', '2015-12-31 22:30:57', '2015-12-31 21:40:29', 'Signed off'),
(5, 'admin', '127.0.0.1', '2015-12-31 23:15:58', '2015-12-31 22:31:19', 'Signed off'),
(6, 'admin', '127.0.0.1', '0000-00-00 00:00:00', '2015-12-31 23:16:01', 'Signed in'),
(7, 'admin', '127.0.0.1', '0000-00-00 00:00:00', '2016-01-02 03:38:13', 'Signed in'),
(8, 'admin', '127.0.0.1', '0000-00-00 00:00:00', '2016-01-02 09:08:51', 'Signed in'),
(9, 'admin', '127.0.0.1', '2016-01-02 10:12:30', '2016-01-02 09:15:10', 'Signed off'),
(10, 'admin', '127.0.0.1', '2016-01-02 10:14:54', '2016-01-02 10:12:43', 'Signed off'),
(11, 'nha', '127.0.0.1', '2016-01-02 10:16:40', '2016-01-02 10:14:58', 'Signed off'),
(12, 'admin', '127.0.0.1', '0000-00-00 00:00:00', '2016-01-02 10:16:44', 'Signed in');
...
(1, 2, 'Accounts', 1, '2015-12-31 15:58:43', 2),
(2, 3, 'Accounts', 1, '2015-12-31 15:59:39', 2),
(3, 4, 'Products', 1, '2015-12-31 16:00:36', 2),
(4, 4, 'Products', 1, '2015-12-31 16:01:22', 0),
(5, 4, 'Products', 1, '2015-12-31 16:01:41', 0),
(6, 5, 'Quotes', 1, '2015-12-31 16:01:53', 2),
(7, 6, 'Accounts', 1, '2015-12-31 16:02:20', 2),
(8, 7, 'Quotes', 1, '2015-12-31 16:03:11', 2),
(9, 8, 'Products', 1, '2015-12-31 16:03:48', 2),
(10, 8, 'Products', 1, '2015-12-31 16:04:12', 0),
(11, 9, 'Contacts', 1, '2016-01-01 02:51:20', 2),
(12, 10, 'Potentials', 1, '2016-01-01 02:52:25', 2),
(13, 12, 'Faq', 1, '2016-01-01 06:25:15', 2),
(14, 13, 'Faq', 1, '2016-01-01 06:26:16', 2);
...
(1, 'accountname', NULL, 'Nguyễn Ho&agrave;i Nam'),
(1, 'account_no', NULL, 'ACC1'),
(1, 'phone', NULL, '01662315624'),
(1, 'website', NULL, 'www.namnguyen.com'),
(1, 'annual_revenue', NULL, '150000000.00000000'),
(1, 'assigned_user_id', NULL, '1'),
(1, 'createdtime', NULL, '2015-12-31 15:58:43'),
(1, 'modifiedby', NULL, '1'),
(1, 'bill_city', NULL, 'Vĩnh Long'),
(1, 'record_id', NULL, '2'),
(1, 'record_module', NULL, 'Accounts'),
(2, 'accountname', NULL, 'Trần Trọng Nghĩa'),
(2, 'account_no', NULL, 'ACC2'),
(2, 'annual_revenue', NULL, '0.00000000'),
(2, 'assigned_user_id', NULL, '1'),
(2, 'createdtime', NULL, '2015-12-31 15:59:39'),
(2, 'modifiedby', NULL, '1'),
(2, 'record_id', NULL, '3'),
(2, 'record_module', NULL, 'Accounts'),
(3, 'productname', NULL, 'Xe honda'),
(3, 'product_no', NULL, 'PRO1'),
(3, 'discontinued', NULL, '1'),
(3, 'createdtime', NULL, '2015-12-31 16:00:36'),
(3, 'modifiedby', NULL, '1'),
...
(4, 'unit_price', '0.00000000', '12000000.00000000'),
(4, 'qty_per_unit', '0.00', '35.00'),
(5, 'qtyinstock', '0.000', '10.000'),
(6, 'quote_no', NULL, 'QUO1'),
(6, 'subject', NULL, 'B&aacute;o g&iacute;a 1'),
(6, 'quotestage', NULL, 'Created'),
(6, 'hdnsubtotal', NULL, '12000000.00000000'),
(6, 'txtadjustment', NULL, '0.00000000'),
(6, 'hdngrandtotal', NULL, '15240000.00000000'),
(6, 'hdntaxtype', NULL, 'group'),
(6, 'hdns_h_amount', NULL, '0.00000000'),
(6, 'account_id', NULL, '3'),
(6, 'assigned_user_id', NULL, '1'),
(6, 'createdtime', NULL, '2015-12-31 16:01:53'),
(6, 'modifiedby', NULL, '1'),
(6, 'currency_id', NULL, '1'),
(6, 'conversion_rate', NULL, '1.000'),
(6, 'bill_street', NULL, 'Cần Thơ'),
(6, 'ship_street', NULL, 'Vĩnh Long'),
...
(6, 'listprice', NULL, '12000000.00000000'),
(6, 'tax1', NULL, '4.500'),
(6, 'tax2', NULL, '10.000'),
(6, 'tax3', NULL, '12.500'),
(6, 'pre_tax_total', NULL, '12000000.00000000'),
(6, 'hdns_h_percent', NULL, '27'),
(6, 'record_id', NULL, '5'),
(6, 'record_module', NULL, 'Quotes'),
(7, 'accountname', NULL, 'Nguyễn Vương Th&agrave;nh T&acirc;m'),
(7, 'account_no', NULL, 'ACC3'),
(7, 'annual_revenue', NULL, '0.00000000'),
(7, 'assigned_user_id', NULL, '1'),
(7, 'createdtime', NULL, '2015-12-31 16:02:20'),
(7, 'modifiedby', NULL, '1'),
(7, 'record_id', NULL, '6'),
(7, 'record_module', NULL, 'Accounts'),
(8, 'quote_no', NULL, 'QUO2'),
(8, 'subject', NULL, 'B&aacute;o g&iacute;a 2'),
(8, 'quotestage', NULL, 'Created'),
(8, 'hdnsubtotal', NULL, '24000000.00000000'),
(8, 'txtadjustment', NULL, '0.00000000'),
(8, 'hdngrandtotal', NULL, '30480000.00000000'),
(8, 'hdntaxtype', NULL, 'group'),
(8, 'hdns_h_amount', NULL, '0.00000000'),
(8, 'account_id', NULL, '6'),
(8, 'assigned_user_id', NULL, '1'),
(8, 'createdtime', NULL, '2015-12-31 16:03:11'),
(8, 'modifiedby', NULL, '1'),
(8, 'currency_id', NULL, '1'),
(8, 'conversion_rate', NULL, '1.000'),
(8, 'bill_street', NULL, 'S&oacute;c Trăng'),
(8, 'ship_street', NULL, 'Cần Thơ'),
(8, 'terms_conditions', NULL, '- Unless otherwise agreed in writing by the supplier all invoices are payable within thirty (30) days of the date of invoice, in the currency of the invoice, drawn on a bank based in India or by such other method as is agreed in advance by the Supplier.\n\n - All prices are not inclusive of VAT which shall be payable in addition by the Customer at the applicable rate.'),
(8, 'productid', NULL, '4'),
(8, 'quantity', NULL, '2.000'),
(8, 'listprice', NULL, '12000000.00000000'),
(8, 'tax1', NULL, '4.500'),
(8, 'tax2', NULL, '10.000'),
(8, 'tax3', NULL, '12.500'),
(8, 'pre_tax_total', NULL, '24000000.00000000'),
(8, 'hdns_h_percent', NULL, '27'),
(8, 'record_id', NULL, '7'),
(8, 'record_module', NULL, 'Quotes'),
(9, 'productname', NULL, 'Rượu Nga'),
(9, 'product_no', NULL, 'PRO2'),
(9, 'createdtime', NULL, '2015-12-31 16:03:48'),
(9, 'modifiedby', NULL, '1'),
...
(10, 'unit_price', '0.00000000', '3560000.00000000'),
(10, 'qty_per_unit', '0.00', '12.00'),
(10, 'qtyinstock', '0.000', '150.000'),
(11, 'salutationtype', NULL, 'Mr.'),
(11, 'firstname', NULL, 'Grace'),
(11, 'contact_no', NULL, 'CON1'),
(11, 'lastname', NULL, 'PackTrict'),
(11, 'mobile', NULL, '0986233166'),
(11, 'assigned_user_id', NULL, '1'),
(11, 'createdtime', NULL, '2016-01-01 02:51:20'),
(11, 'modifiedby', NULL, '1'),
(11, 'support_start_date', NULL, '2016-01-01'),
(11, 'support_end_date', NULL, '2017-01-01'),
(11, 'record_id', NULL, '9'),
(11, 'record_module', NULL, 'Contacts'),
(12, 'potentialname', NULL, 'Cơ hội b&aacute;n h&agrave;ng'),
(12, 'potential_no', NULL, 'POT1'),
(12, 'amount', NULL, '0.00000000'),
(12, 'closingdate', NULL, '2017-01-02'),
(12, 'sales_stage', NULL, 'Prospecting'),
(12, 'assigned_user_id', NULL, '1'),
(12, 'probability', NULL, '0.000'),
(12, 'createdtime', NULL, '2016-01-01 02:52:25'),
(12, 'modifiedby', NULL, '1'),
(12, 'forecast_amount', NULL, '0.00000000'),
(12, 'record_id', NULL, '10'),
(12, 'record_module', NULL, 'Potentials'),
(13, 'faq_no', NULL, 'FAQ1'),
(13, 'faqcategories', NULL, 'General'),
(13, 'faqstatus', NULL, 'Draft'),
(13, 'question', NULL, 'a'),
(13, 'faq_answer', NULL, 'aa'),
(13, 'createdtime', NULL, '2016-01-01 06:25:15'),
(13, 'modifiedby', NULL, '1'),
(13, 'record_id', NULL, '12'),
(13, 'record_module', NULL, 'Faq'),
(14, 'faq_no', NULL, 'FAQ2'),
(14, 'faqcategories', NULL, 'General'),
(14, 'faqstatus', NULL, 'Published'),
(14, 'question', NULL, 'b'),
(14, 'faq_answer', NULL, 'b'),
(14, 'createdtime', NULL, '2016-01-01 06:26:16'),
(14, 'modifiedby', NULL, '1'),
(14, 'record_id', NULL, '13'),
(14, 'record_module', NULL, 'Faq');
...
(2, 'Accounts', '01662315624', '42651326610', 'phone'),
(9, 'Contacts', '0986233166', '6613326890', 'mobile');

-- --------------------------------------------------------

--
-- Table structure for table `vtiger_personnote`
--

CREATE TABLE IF NOT EXISTS `vtiger_personnote` (
  `personnoteid` int(11) DEFAULT NULL,
  `title` varchar(255) DEFAULT NULL,
  `summary` longtext CHARACTER SET armscii8 COLLATE armscii8_bin NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `vtiger_personnote`
--

INSERT INTO `vtiger_personnote` (`personnoteid`, `title`, `summary`) VALUES
(16, 'Gặp mặt xếp', '');

-- --------------------------------------------------------

--
-- Table structure for table `vtiger_personnotecf`
--

CREATE TABLE IF NOT EXISTS `vtiger_personnotecf` (
  `personnoteid` int(11) NOT NULL,
  `cf_781` text,
  `cf_785` text
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `vtiger_personnotecf`
--

INSERT INTO `vtiger_personnotecf` (`personnoteid`, `cf_781`, `cf_785`) VALUES
(16, '-Chuẩn bị một số vật dụng báo cáo', 'Medium');
...
(10, 'POT1', 0, 'Cơ hội bán hàng', 0.00000000, NULL, '2017-01-02', NULL, '', 0, 0.000, 0, 'Prospecting', '', '', NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 0, 0.00000000, '0', 0);
...
(4, 1, 12000000.00000000, 12000000.00000000),
(8, 1, 3560000.00000000, 3560000.00000000);
...
(4, 'PRO1', 'Xe honda', '', '', '', 35.00, 12000000.00000000, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.000, NULL, 1, '', 0, '', '', '', '', '', 10.000, '', 0, '', 0, '', 1),
(8, 'PRO2', 'Rượu Nga', '', '', '', 12.00, 3560000.00000000, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.000, NULL, 0, '', 0, '', '', '', '', '', 150.000, '', 0, '', 0, '', 1);
...
(5, 'Báo gía 1', NULL, 'Created', NULL, NULL, 'QUO1', 12000000.00000000, '', '', 0, NULL, 0.00000000, 15240000.00000000, 'group', NULL, NULL, 0.00000000, 3, '- Unless otherwise agreed in writing by the supplier all invoices are payable within thirty (30) days of the date of invoice, in the currency of the invoice, drawn on a bank based in India or by such other method as is agreed in advance by the Supplier.\n\n - All prices are not inclusive of VAT which shall be payable in addition by the Customer at the applicable rate.', 1, 1.000, 12000000.00000000, 27),
(7, 'Báo gía 2', NULL, 'Created', NULL, NULL, 'QUO2', 24000000.00000000, '', '', 0, NULL, 0.00000000, 30480000.00000000, 'group', NULL, NULL, 0.00000000, 6, '- Unless otherwise agreed in writing by the supplier all invoices are payable within thirty (30) days of the date of invoice, in the currency of the invoice, drawn on a bank based in India or by such other method as is agreed in advance by the Supplier.\n\n - All prices are not inclusive of VAT which shall be payable in addition by the Customer at the applicable rate.', 1, 1.000, 24000000.00000000, 27);
...
(90, 4, 35, 'get_dependents_list', 13, 'PBXManager', 0, ''),
(91, 7, 35, 'get_dependents_list', 7, 'PBXManager', 0, ''),
(92, 6, 35, 'get_dependents_list', 14, 'PBXManager', 0, ''),
(93, 36, 13, 'get_related_list', 1, 'Service Requests', 0, 'ADD,SELECT'),
(94, 36, 8, 'get_attachments', 2, 'Documents', 0, 'ADD,SELECT'),
(95, 6, 36, 'get_dependents_list', 15, 'Service Contracts', 0, 'ADD'),
(96, 4, 36, 'get_dependents_list', 14, 'Service Contracts', 0, 'ADD'),
(97, 13, 36, 'get_related_list', 5, 'Service Contracts', 0, 'ADD,SELECT'),
...
(121, 6, 40, 'get_dependents_list', 17, 'Projects', 0, 'add'),
(122, 4, 40, 'get_dependents_list', 16, 'Projects', 0, 'add'),
(123, 13, 40, 'get_related_list', 7, 'Projects', 0, 'SELECT'),
(124, 41, 6, 'get_related_list', 1, 'Accounts', 0, ' '),
(125, 41, 4, 'get_related_list', 2, 'Contacts', 0, ' '),
(126, 41, 7, 'get_related_list', 3, 'Leads', 0, ' '),
...
(132, 39, 8, 'get_attachments', 1, 'Documents', 0, 'ADD,SELECT'),
(133, 40, 39, 'get_dependents_list', 1, 'Project Tasks', 0, 'ADD'),
(134, 40, 38, 'get_dependents_list', 2, 'Project Milestones', 0, 'ADD'),
(135, 40, 8, 'get_attachments', 3, 'Documents', 0, 'ADD,SELECT'),
(136, 40, 13, 'get_related_list', 4, 'HelpDesk', 0, 'ADD,SELECT'),
(137, 40, 0, 'get_gantt_chart', 5, 'Charts', 0, ''),
...
(26, 13, 'Chart', '', 'chart', 26, 'CUSTOM', 1, 1, 1, 'Public');
...
(26, '{"type":"pieChart","groupbyfield":"vtiger_products:productname:Products_Product_Name:productname:V","datafields":["vtiger_products:unit_price:Products_Unit_Price:unit_price:N:SUM"]}');
...
(33, 3, 'ModuleDesigner', 'layouts/vlayout/modules/Settings/ModuleDesigner/assets/images/ModuleDesigner.png', 'LBL_MODULEDESIGNER_DESCRIPTION', 'index.php?module=ModuleDesigner&view=Index&parent=Settings', 8, 0, 0);
...
(30, 'WSAPP', 0, -1, 'WSAPP', NULL, NULL, 1, 0, 0, 0, '3.4.4', ''),
(31, 'Import', 0, -1, 'Import', NULL, NULL, 1, 0, 0, 0, '1.7', ''),
(32, 'ModTracker', 0, -1, 'ModTracker', NULL, NULL, 0, 0, 0, 0, '1.2', ''),
(33, 'MailManager', 0, -1, 'MailManager', NULL, NULL, 1, 0, 0, 0, '1.9', 'Tools'),
(34, 'Mobile', 0, -1, 'Mobile', NULL, NULL, 1, 0, 0, 0, '2.0', ''),
(35, 'PBXManager', 0, -1, 'PBXManager', NULL, NULL, 1, 0, 1, 0, '2.2', 'Tools'),
(36, 'ServiceContracts', 0, -1, 'Service Contracts', NULL, NULL, 0, 0, 1, 0, '2.4', 'Support'),
(37, 'Services', 0, -1, 'Services', NULL, NULL, 0, 0, 1, 0, '2.6', 'Inventory'),
(38, 'ProjectMilestone', 0, -1, 'ProjectMilestone', NULL, NULL, 0, 0, 1, 0, '3.0', 'Support'),
(39, 'ProjectTask', 0, -1, 'ProjectTask', NULL, NULL, 0, 0, 1, 0, '3.1', 'Support'),
(40, 'Project', 0, -1, 'Project', NULL, NULL, 0, 0, 1, 0, '3.3', 'Support'),
(41, 'SMSNotifier', 0, -1, 'SMSNotifier', NULL, NULL, 0, 0, 1, 0, '1.9', 'Tools'),
(42, 'ModComments', 0, -1, 'Comments', NULL, NULL, 0, 0, 1, 0, '2.1', 'Tools'),
(43, 'CustomerPortal', 0, -1, 'CustomerPortal', NULL, NULL, 0, 0, 0, 0, '1.4', ''),
(44, 'EmailTemplates', 0, -1, 'Email Templates', NULL, NULL, 1, 0, 0, 0, '1.0', 'Tools'),
(45, 'Google', 0, -1, 'Google', NULL, NULL, 0, 0, 0, 0, '1.5', ''),
(46, 'Webforms', 0, -1, 'Webforms', NULL, NULL, 0, 0, 0, 0, '1.6', ''),
...
(50, 'ModuleDesigner', 0, -1, 'Module Designer', NULL, NULL, 1, 0, 0, 0, '0.9', ''),
(55, 'PersonNote', 0, 9, 'PersonNote', NULL, NULL, 1, 0, 1, 0, '0', 'Tools');
...
(51, 'vtiger_min_version', '6.0.0'),
(52, 'vtiger_min_version', '6.0.0');
...
--
-- Table structure for table `vtiger_testmodule`
--

CREATE TABLE IF NOT EXISTS `vtiger_testmodule` (
  `testmoduleid` int(11) DEFAULT NULL,
  `testmodule` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `vtiger_testmodule`
--

INSERT INTO `vtiger_testmodule` (`testmoduleid`, `testmodule`) VALUES
(15, 'a');

-- --------------------------------------------------------

--
-- Table structure for table `vtiger_testmodulecf`
--

CREATE TABLE IF NOT EXISTS `vtiger_testmodulecf` (
  `testmoduleid` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `vtiger_testmodulecf`
--

INSERT INTO `vtiger_testmodulecf` (`testmoduleid`) VALUES
(15);
...
(1, 'admin', '$1$ad000000$hzXFXvL3XVlnUE/X.1n9t/', 'd41d8cd98f00b204e9800998ecf8427e', '#E6FAD8', 'Phi', 'Nguyen Thanh', '', 'on', 1, '', '2015-12-31 14:47:49', '0000-00-00 00:00:00', NULL, '', '', '', '', '', '', '', 'thanhphi0127@gmail.com', '', '', 'Active', '', '', '', '', '', '', NULL, NULL, NULL, NULL, NULL, NULL, 'dd-mm-yyyy', '12', '00:00', '23:00', 'This Week', 'Today', '', 0, '$1$ad000000$nYTnfhTZRmUP.wQT9y1AE.', '1', '1 Minute', NULL, 'PHP5.3MD5', 'lWAfN6IAxufpqmGm', 'bluelagoon', 'en_us', 'Asia/Bangkok', '123,456,789', '.', ',', '$1.0', '', '2', '1', 'Sunday', '5', '5', 'public', 'Summary', '0', 'medium', NULL, NULL, 0, '1'),
(5, 'nha', '$1$nh000000$lQx3XSFs0WkFEEmlJ9HZV1', '21232f297a57a5a743894a0e4a801fc3', '#E6FAD8', 'Nhã', 'Huỳnh Thanh', '', 'off', 1, '', '2016-01-02 17:15:55', '0000-00-00 00:00:00', NULL, '', '', '', '', '', '', '', 'thanhnha36@gmail.com', '', '', 'Active', '', '', '', '', '', '', NULL, NULL, NULL, NULL, NULL, NULL, 'dd-mm-yyyy', '12', '00:00', '', 'Today', 'Today', '', 0, '$1$nh000000$lQx3XSFs0WkFEEmlJ9HZV1', '0', '', NULL, 'PHP5.3MD5', 'UBndf5t7TC3xUAer', 'nature', 'en_us', 'Asia/Bangkok', '123,456,789', '.', '.', '$1.0', '', '2', '0', 'Monday', '5', '5', 'public', 'Summary', '0', 'medium', 'Select an Option', 'Select an Option', 0, '0');
...
(1, 'vtigerCRM', '56853d67551a0', 'user');
...
(31, 'ModComments', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1),
...
(40, 'PersonNote', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', 1);
...
--
-- Indexes for table `vtiger_cf_785`
--
ALTER TABLE `vtiger_cf_785`
  ADD PRIMARY KEY (`cf_785id`);
...
--
-- Indexes for table `vtiger_personnotecf`
--
ALTER TABLE `vtiger_personnotecf`
  ADD PRIMARY KEY (`personnoteid`);
...
--
-- Indexes for table `vtiger_testmodulecf`
--
ALTER TABLE `vtiger_testmodulecf`
  ADD PRIMARY KEY (`testmoduleid`);
...
--
-- AUTO_INCREMENT for table `vtiger_cf_785`
--
ALTER TABLE `vtiger_cf_785`
  MODIFY `cf_785id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
...
--
ALTER TABLE `vtiger_def_org_share`
  MODIFY `ruleid` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=31;
--
...
--
ALTER TABLE `vtiger_field`
  MODIFY `fieldid` int(19) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=787;
--
...
--
ALTER TABLE `vtiger_inventoryproductrel`
  MODIFY `lineitem_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `vtiger_picklist`
  MODIFY `picklistid` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=51;
--
...
--
ALTER TABLE `vtiger_reportfolder`
  MODIFY `folderid` int(19) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=14;
--
